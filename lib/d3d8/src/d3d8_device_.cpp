...
D3DAPI HRESULT D3DDevice::DrawIndexedVertices(
    D3DPRIMITIVETYPE PrimitiveType,
    UINT VertexCount, CONST WORD *pIndexData)
{
    return IDirect3DDevice8_DrawIndexedVertices(this,
...
D3DAPI HRESULT IDirect3DDevice8_DrawIndexedVertices(
    ...
    UINT VertexCount, CONST WORD *pIndexData)
{
    return pThis->DrawIndexedVertices(PrimitiveType, VertexCount, pIndexData);
}
