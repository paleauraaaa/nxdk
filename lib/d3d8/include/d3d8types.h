...
typedef enum _D3DCUBEMAP_FACES: UINT {
...
typedef enum _D3DMULTISAMPLE_TYPE: DWORD {
...
typedef enum _D3DMULTISAMPLEMODE: UINT {
...
typedef enum _D3DSWAPEFFECT: UINT {
...
typedef enum _D3DFILLMODE: DWORD {
...
typedef enum _D3DBLENDOP: DWORD {
...
typedef enum _D3DCMPFUNC: DWORD {
...
typedef enum _D3DSTENCILOP: DWORD {
...
typedef enum _D3DFOGMODE: DWORD {
    D3DFOG_NONE                 = 0,
...
typedef enum _D3DSWATHWIDTH: DWORD {
...
typedef enum _D3DLOGICOP: DWORD {
    D3DLOGICOP_NONE             = 0,
...
typedef enum _PS_CHANNEL {
    PS_CHANNEL_RGB      = 0x00000000,
    PS_CHANNEL_BLUE     = 0x00000000,
    PS_CHANNEL_ALPHA    = 0x00000010,
} _PS_CHANNEL;
...
typedef enum _D3DLOCKFLAGS: DWORD {
    D3DLOCK_NOFLUSH         = 0x00000010,
    D3DLOCK_NOOVERWRITE     = 0x00000020,
    D3DLOCK_TILED           = 0x00000040,
    D3DLOCK_READONLY        = 0x00000080,
} D3DLOCKFLAGS;
...
#define D3DVSDE_POSITION        NV2A_VERTEX_ATTR_POSITION
#define D3DVSDE_BLENDWEIGHT     NV2A_VERTEX_ATTR_WEIGHT
#define D3DVSDE_NORMAL          NV2A_VERTEX_ATTR_NORMAL
#define D3DVSDE_DIFFUSE         NV2A_VERTEX_ATTR_DIFFUSE
#define D3DVSDE_SPECULAR        NV2A_VERTEX_ATTR_SPECULAR
#define D3DVSDE_FOG             NV2A_VERTEX_ATTR_FOG_COORD
#define D3DVSDE_PSIZE           NV2A_VERTEX_ATTR_POINT_SIZE
#define D3DVSDE_BACKDIFFUSE     NV2A_VERTEX_ATTR_BACK_DIFFUSE
#define D3DVSDE_BACKSPECULAR    NV2A_VERTEX_ATTR_BACK_SPECULAR
#define D3DVSDE_TEXCOORD0       NV2A_VERTEX_ATTR_TEXTURE0
#define D3DVSDE_TEXCOORD1       NV2A_VERTEX_ATTR_TEXTURE1
#define D3DVSDE_TEXCOORD2       NV2A_VERTEX_ATTR_TEXTURE2
#define D3DVSDE_TEXCOORD3       NV2A_VERTEX_ATTR_TEXTURE3
#define D3DVSDE_USER1           NV2A_VERTEX_ATTR_13
#define D3DVSDE_USER2           NV2A_VERTEX_ATTR_14
#define D3DVSDE_USER3           NV2A_VERTEX_ATTR_15

// pixel/vertex shader end token
#define D3DPS_END()  0x0000FFFF
#define D3DVS_END()  0x0000FFFF

typedef enum D3DPOOL: UINT {
    D3DPOOL_DEFAULT,
} D3DPOOL;
...
typedef enum _PS_COMBINERCOUNTFLAGS {
    PS_COMBINERCOUNT_MUX_LSB    = 0x00000000,
    PS_COMBINERCOUNT_MUX_MSB    = 0x00000001,

    PS_COMBINERCOUNT_SAME_C0    = 0x00000000,
    PS_COMBINERCOUNT_UNIQUE_C0  = 0x00000010,

    PS_COMBINERCOUNT_SAME_C1    = 0x00000000,
    PS_COMBINERCOUNT_UNIQUE_C1  = 0x00000100
...
typedef enum _D3DCLEAR: DWORD {
    ...
    D3DCLEAR_TARGET_R = NV097_CLEAR_SURFACE_R,
    D3DCLEAR_TARGET_G = NV097_CLEAR_SURFACE_G,
    D3DCLEAR_TARGET_B = NV097_CLEAR_SURFACE_B,
    D3DCLEAR_TARGET_A = NV097_CLEAR_SURFACE_A,
} _D3DCLEAR;
...
typedef enum _D3DTEXTUREADDRESS: DWORD {
...
typedef enum _D3DTEXTURECOLORKEYOP: DWORD {
...
typedef enum _D3DTEXTUREALPHAKILL: DWORD {
